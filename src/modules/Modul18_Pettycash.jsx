...
// ============================================================
const STAFF_LIST = [
  { id:"EMP001", nama:"Muh. Krisna Mukti",   jabatan:"Clean & Service",    shift:"Pagi"       },
  { id:"EMP002", nama:"Gurit Yudho Anggoro", jabatan:"Staf Penjaga Malam", shift:"Sore/Malam" },
  { id:"EMP003", nama:"Rina Manajemen",      jabatan:"Super Admin",        shift:"Pagi"       },
];
...
const TOPUP_INIT = [
  { id:"TU001", tanggal:"2026-02-01", nominal:1500000, keterangan:"Jatah petty cash Februari 2026", adminId:"EMP003" },
  { id:"TU002", tanggal:"2026-02-18", nominal:500000,  keterangan:"Top-up darurat — saldo menipis",  adminId:"EMP003" },
];

const BELANJA_INIT = [
  { id:"B001", tanggal:"2026-02-02", staffId:"EMP001", kategori:"galon",      item:"Air galon isi ulang 3 galon",              nominal:21000,  foto:false, status:"verified", kasId:"KAS-2026-02-001", keterangan:"" },
  { id:"B002", tanggal:"2026-02-03", staffId:"EMP001", kategori:"trashbag",   item:"Trash bag hitam besar 1 rol",              nominal:28000,  foto:true,  status:"verified", kasId:"KAS-2026-02-002", keterangan:"" },
  { id:"B003", tanggal:"2026-02-05", staffId:"EMP002", kategori:"chemical",   item:"Sabun lantai Wipol 800ml × 2",             nominal:46000,  foto:true,  status:"verified", kasId:"KAS-2026-02-003", keterangan:"" },
  { id:"B004", tanggal:"2026-02-07", staffId:"EMP001", kategori:"listrik",    item:"Lampu LED 10W × 3 buah",                  nominal:87000,  foto:true,  status:"verified", kasId:"KAS-2026-02-004", keterangan:"" },
  { id:"B005", tanggal:"2026-02-10", staffId:"EMP002", kategori:"kamarmandi", item:"Sabun cair cuci tangan isi ulang",         nominal:32000,  foto:false, status:"verified", kasId:"KAS-2026-02-005", keterangan:"" },
  { id:"B006", tanggal:"2026-02-12", staffId:"EMP001", kategori:"kebersihan", item:"Sapu ijuk baru 1 buah",                   nominal:35000,  foto:true,  status:"verified", kasId:"KAS-2026-02-006", keterangan:"" },
  { id:"B007", tanggal:"2026-02-14", staffId:"EMP001", kategori:"galon",      item:"Air galon isi ulang 4 galon",              nominal:28000,  foto:false, status:"verified", kasId:"KAS-2026-02-007", keterangan:"" },
  { id:"B008", tanggal:"2026-02-17", staffId:"EMP002", kategori:"chemical",   item:"Bayclin putih 900ml × 2",                 nominal:52000,  foto:true,  status:"verified", kasId:"KAS-2026-02-008", keterangan:"" },
  { id:"B009", tanggal:"2026-02-19", staffId:"EMP001", kategori:"trashbag",   item:"Trash bag medium 2 pak",                  nominal:24000,  foto:false, status:"verified", kasId:"KAS-2026-02-009", keterangan:"" },
  { id:"B010", tanggal:"2026-02-21", staffId:"EMP002", kategori:"tanaman",    item:"Pupuk cair tanaman hias",                 nominal:18000,  foto:true,  status:"verified", kasId:"KAS-2026-02-010", keterangan:"" },
  { id:"B011", tanggal:"2026-02-23", staffId:"EMP001", kategori:"kamarmandi", item:"Tisu toilet 6 roll × 2 pack",             nominal:44000,  foto:true,  status:"verified", kasId:"KAS-2026-02-011", keterangan:"" },
  { id:"B012", tanggal:"2026-02-24", staffId:"EMP002", kategori:"galon",      item:"Air galon isi ulang 3 galon",              nominal:21000,  foto:false, status:"verified", kasId:"KAS-2026-02-012", keterangan:"" },
  { id:"B013", tanggal:"2026-02-25", staffId:"EMP001", kategori:"chemical",   item:"Karbol wangi 800ml × 3",                  nominal:63000,  foto:true,  status:"pending",  kasId:null, keterangan:"" },
  { id:"B014", tanggal:"2026-02-25", staffId:"EMP002", kategori:"lainnya",    item:"Kabel ties + lakban hitam",               nominal:27000,  foto:false, status:"pending",  kasId:null, keterangan:"" },
  { id:"B015", tanggal:"2026-02-26", staffId:"EMP001", kategori:"galon",      item:"Air galon isi ulang 5 galon",              nominal:35000,  foto:true,  status:"pending",  kasId:null, keterangan:"" },
];
