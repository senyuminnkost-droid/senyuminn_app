...
const ModulMonitor    = lazy(() => import("./senyuminn_modul2_monitor"));
const ModulKeluhan    = lazy(() => import("./senyuminn_modul2_keluhan"));
const ModulWeekly     = lazy(() => import("./senyuminn_modul3_weekly"));
const ModulAbsensi    = lazy(() => import("./senyuminn_modul4_absensi"));
const ModulPenyewa    = lazy(() => import("./senyuminn_modul5_penyewa"));
const ModulCheckin    = lazy(() => import("./senyuminn_modul6_checkin"));
const ModulTagihan    = lazy(() => import("./senyuminn_modul7_tagihan"));
const ModulKas        = lazy(() => import("./senyuminn_modul8_kas"));
const ModulLaporan    = lazy(() => import("./senyuminn_modul9_laporan"));
const ModulKaryawan   = lazy(() => import("./senyuminn_modul10_karyawan"));
const ModulPenggajian = lazy(() => import("./senyuminn_modul11_penggajian"));
const ModulLapAbsensi = lazy(() => import("./senyuminn_modul12_absensi"));
const ModulPengaturan = lazy(() => import("./senyuminn_modul13_pengaturan"));
const ModulRiwayat    = lazy(() => import("./senyuminn_modul14_riwayat"));
const ModulKalender   = lazy(() => import("./senyuminn_modul15_kalender"));
const ModulJobdesk    = lazy(() => import("./senyuminn_modul16_jobdesk"));
const ModulPettyCash  = lazy(() => import("./senyuminn_modul17_pettycash"));
