...
const STAFF_LIST = [
  { id: 3, name: "Muh. Krisna Mukti", jabatan: "Clean & Service" },
  { id: 4, name: "Gurit Yudho Anggoro", jabatan: "Staf Penjaga Malam" },
];

const INITIAL_TIKET = [
  {
    id: "T001", lokasi: "kamar", kamar: 9, area: null,
    kategori: "AC Bermasalah", prioritas: "urgent",
    status: "open", tanggal: "2026-02-25", deskripsi: "AC bocor, air menetes ke lantai kamar. Sudah berlangsung 2 hari.",
    assignee: null, biaya: null, resolusi: null, riwayat: [
      { waktu: "2026-02-25 08:12", aksi: "Tiket dibuat oleh Dewi Lestari (penyewa)", aktor: "Penyewa" },
    ],
  },
  {
    id: "T002", lokasi: "kamar", kamar: 1, area: null,
    kategori: "Listrik", prioritas: "normal",
    status: "in-progress", tanggal: "2026-02-24", deskripsi: "Lampu kamar mandi redup dan kadang mati sendiri.",
    assignee: 3, biaya: null, resolusi: null, riwayat: [
      { waktu: "2026-02-24 14:30", aksi: "Tiket dibuat oleh Admin", aktor: "Admin" },
      { waktu: "2026-02-24 15:00", aksi: "Ditugaskan ke Muh. Krisna Mukti", aktor: "Admin" },
      { waktu: "2026-02-25 09:00", aksi: "Status diubah ke In Progress", aktor: "Krisna" },
    ],
  },
  {
    id: "T003", lokasi: "kamar", kamar: 5, area: null,
    kategori: "Air", prioritas: "normal",
    status: "open", tanggal: "2026-02-23", deskripsi: "Keran air di wastafel tidak bisa mati sepenuhnya, selalu menetes.",
    assignee: null, biaya: null, resolusi: null, riwayat: [
      { waktu: "2026-02-23 11:45", aksi: "Tiket dibuat oleh Staff saat weekly service", aktor: "Staff" },
    ],
  },
  {
    id: "T004", lokasi: "kamar", kamar: 5, area: null,
    kategori: "Bangunan", prioritas: "normal",
    status: "ditunda", tanggal: "2026-02-20", deskripsi: "Pintu kamar susah dikunci dari luar, handle longgar.",
    assignee: 3, biaya: null, resolusi: null, riwayat: [
      { waktu: "2026-02-20 10:00", aksi: "Tiket dibuat oleh Admin", aktor: "Admin" },
      { waktu: "2026-02-21 08:00", aksi: "Ditunda — menunggu suku cadang", aktor: "Krisna" },
    ],
  },
  {
    id: "T005", lokasi: "umum", kamar: null, area: "Selasar Lt.2",
    kategori: "Listrik", prioritas: "normal",
    status: "selesai", tanggal: "2026-02-15", deskripsi: "Lampu selasar lantai 2 mati total sejak malam.",
    assignee: 3, biaya: 45000, resolusi: "Ganti bohlam LED 15W. Sudah normal.", riwayat: [
      { waktu: "2026-02-15 06:30", aksi: "Tiket dibuat oleh Gurit (penjaga malam)", aktor: "Staff" },
      { waktu: "2026-02-15 08:30", aksi: "Ditugaskan ke Muh. Krisna Mukti", aktor: "Admin" },
      { waktu: "2026-02-15 10:00", aksi: "Perbaikan selesai — bohlam diganti", aktor: "Krisna" },
      { waktu: "2026-02-15 10:05", aksi: "Biaya Rp 45.000 diinput", aktor: "Krisna" },
      { waktu: "2026-02-15 11:00", aksi: "Diverifikasi oleh Admin — masuk kas", aktor: "Admin" },
    ],
  },
  {
    id: "T006", lokasi: "umum", kamar: null, area: "Kamar Mandi Lt.1",
    kategori: "Air", prioritas: "urgent",
    status: "selesai", tanggal: "2026-02-10", deskripsi: "Closet mampet, air meluap ke lantai kamar mandi umum.",
    assignee: 4, biaya: 150000, resolusi: "Saluran dibersihkan dan disiram cairan pembersih saluran.", riwayat: [
      { waktu: "2026-02-10 07:00", aksi: "Tiket URGENT dibuat — notif WA terkirim", aktor: "Admin" },
      { waktu: "2026-02-10 07:30", aksi: "Ditangani langsung oleh Gurit Yudho", aktor: "Gurit" },
      { waktu: "2026-02-10 09:00", aksi: "Selesai — input biaya Rp 150.000", aktor: "Gurit" },
    ],
  },
];
